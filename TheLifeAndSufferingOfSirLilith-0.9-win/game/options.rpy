...
define config.name = _("Учёба и страдания Лилит в ФГАОУ ВО УрФУ в эпоху краха балженной сионисткой империи")
...
define gui.about = _p("""
Абитуриент скачать
Учебно-методические материалы для обучения и повышения квалификации в сфере выбора высшего образовательного учреждения
в формате визуальная новелла "Учёба и Страдания Лилит в ФГАОУ ВО "УрФУ" в эпоху краха блаженной сионистской империи"

Разработано командой БМП
""")
...
define build.name = "TheLifeAndSufferingOfSirLilith"
...
define config.main_menu_music = "endtheme.mp3"
...
define config.save_directory = "BeslyanNordOst-1696865906"
